...
var
  FFormaFechaMtto: TFFormaFechaMtto;
  sFecha: string;
...
procedure TFFormaFechaMtto.SetDate(Date: TDateTime);
begin
  Calendar1.CalendarDate := Date;
end;

function TFFormaFechaMtto.GetDate: TDateTime;
begin
  Result := Calendar1.CalendarDate;
end;

procedure TFFormaFechaMtto.PrevMonthBtnClick(Sender: TObject);
begin
  Calendar1.PrevYear;
end;

procedure TFFormaFechaMtto.NextMonthBtnClick(Sender: TObject);
begin
  Calendar1.NextYear;
end;

procedure TFFormaFechaMtto.Calendar1Change(Sender: TObject);
var cadena:string;
begin
  try
...
procedure TFFormaFechaMtto.Calendar1DblClick(Sender: TObject);
begin
  ModalResult := mrOK;
end;

procedure TFFormaFechaMtto.FormActivate(Sender: TObject);
...
procedure TFFormaFechaMtto.SpeedButton2Click(Sender: TObject);
begin
  Calendar1.PrevMonth;
end;

procedure TFFormaFechaMtto.SpeedButton3Click(Sender: TObject);
begin
  Calendar1.NextMonth;
end;

procedure TFFormaFechaMtto.iMesesMouseDown(Sender: TObject;
...
procedure TFFormaFechaMtto.MesClic(Sender: TObject);
begin
Calendar1.Month:=(Sender as TMenuItem).Tag;
end;

procedure TFFormaFechaMtto.seAgnosExit(Sender: TObject);
begin
  seAgnos.Hide;
end;

procedure TFFormaFechaMtto.iAgnosMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TFFormaFechaMtto.seAgnosChange(Sender: TObject);
begin
  Calendar1.Year:=seAgnos.Value;
end;

procedure TFFormaFechaMtto.Calendar1Click(Sender: TObject);
begin
  seAgnos.Hide;
end;

procedure TFFormaFechaMtto.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
...
procedure TFFormaFechaMtto.FormCreate(Sender: TObject);
begin
 height:=250;
end;

procedure TFFormaFechaMtto.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  height:=250;
end;

procedure TFFormaFechaMtto.seSegundosChange(Sender: TObject);
var Tiempo:TDateTime;
begin
 try
  Tiempo:=EncodeTime(seHora.value, seMinutos.value, 0, 0);
...
procedure TFFormaFechaMtto.BitBtn1Click(Sender: TObject);
var Tiempo:TDateTime;
begin
  Tiempo:=EncodeTime(seHora.value, seMinutos.value, 0, 0);
 // Tiempo:=EncodeTime(seHora.value, seMinutos.value, seSegundos.value, 0);
...
procedure TFFormaFechaMtto.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if (Key = #13) then
