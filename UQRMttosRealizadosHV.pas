...
type
  TFQRMttosRealizadosHV = class(TForm)
    QuickRep1: TQuickRep;
    QRBand2: TQRBand;
    tEmpresaLogo: TTable;
...
var
  FQRMttosRealizadosHV: TFQRMttosRealizadosHV;

implementation

{$R *.DFM}

procedure TFQRMttosRealizadosHV.QuickRep1AfterPreview(Sender: TObject);
begin
  close;
...
procedure TFQRMttosRealizadosHV.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=cafree;
end;

procedure TFQRMttosRealizadosHV.qMttoReprogramadoCalcFields(DataSet: TDataSet);
begin
  qElementoMtto.Close;
...
procedure TFQRMttosRealizadosHV.consultarElemento(codigotipoelemento:string);
...
procedure TFQRMttosRealizadosHV.FormCreate(Sender: TObject);
begin
  qElementoMtto.Open;
end;
