...
type
  TfQRActividadContrato = class(TFQRBase)
    QRShape8: TQRShape;
    QRLabel3: TQRLabel;
    QRShape9: TQRShape;
    QRLabel6: TQRLabel;
...
var
  fQRActividadContrato: TfQRActividadContrato;
...
procedure TfQRActividadContrato.qlAreaFuncionalPrint(sender: TObject;
  var Value: String);
begin
  value:=qCia.fieldbyname('nombrecategoria').AsString;
end;

procedure TfQRActividadContrato.QuickReportBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
//
end;

procedure TfQRActividadContrato.QuickReportAfterPreview(Sender: TObject);
begin
  close;
end;

procedure TfQRActividadContrato.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=cafree;
end;

procedure TfQRActividadContrato.qContratoCalcFields(DataSet: TDataSet);
begin
...
procedure TfQRActividadContrato.QRSysData2Print(sender: TObject;
  var Value: String);
begin
  inherited;
  value:='';
