...
var
  fQRODTPadreAtras: TfQRODTPadreAtras;
...
procedure TfQRODTPadreAtras.QuickRep1AfterPreview(Sender: TObject);
begin
  Close;
end;

procedure TfQRODTPadreAtras.FormClose(Sender: TObject;
...
procedure TfQRODTPadreAtras.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
