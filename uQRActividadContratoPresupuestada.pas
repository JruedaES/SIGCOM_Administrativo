unit uQRActividadContratoPresupuestada;
...
type
  TfQRActividadContratoPresupuestada = class(TFQRBase)
    QRShape8: TQRShape;
    QRLabel3: TQRLabel;
    QRShape9: TQRShape;
    QRLabel6: TQRLabel;
...
var
  fQRActividadContratoPresupuestada: TfQRActividadContratoPresupuestada;
...
procedure TfQRActividadContratoPresupuestada.qlAreaFuncionalPrint(sender: TObject;
  var Value: String);
begin
  value:=qCia.fieldbyname('nombrecategoria').AsString;
end;

procedure TfQRActividadContratoPresupuestada.QuickReportBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
//
end;

procedure TfQRActividadContratoPresupuestada.QuickReportAfterPreview(Sender: TObject);
begin
  close;
end;

procedure TfQRActividadContratoPresupuestada.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=cafree;
end;

procedure TfQRActividadContratoPresupuestada.qContratoCalcFields(DataSet: TDataSet);
begin
...
procedure TfQRActividadContratoPresupuestada.QRSysData2Print(
