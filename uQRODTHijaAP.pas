...
procedure TfQRODTHijaAP.QRDBText9Print(sender: TObject;
  var Value: String);
begin
...
procedure TfQRODTHijaAP.qrdbFechaAprobacionPrint(sender: TObject;
  var Value: String);
begin
...
procedure TfQRODTHijaAP.qrdbFechaAsignacionPrint(sender: TObject;
  var Value: String);
begin
    if Trim(Value) = '30    12    1899' then
      Value:='';
...
procedure TfQRODTHijaAP.qrdbFechaInicioTrabajoPrint(
...
procedure TfQRODTHijaAP.qrdbFechaFinalTrabajoPrint(sender: TObject;
  var Value: String);
begin
   if Trim(Value) = '30    12    1899      00 : 00' then
      Value:='';
...
procedure TfQRODTHijaAP.QRDBText8Print(sender: TObject;
  var Value: String);
begin
   if Trim(Value) = '30    12    1899      00 : 00' then
      Value:='';
...
procedure TfQRODTHijaAP.qODTPadreCalcFields(DataSet: TDataSet);
...
procedure TfQRODTHijaAP.QuickRep1AfterPreview(Sender: TObject);
begin
  close;
end;

procedure TfQRODTHijaAP.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=CaFree;
end;

procedure TfQRODTHijaAP.QRLabelPrint(sender: TObject; var Value: String);
begin
