...
var
  FdFiltrarGrupo: TFdFiltrarGrupo;

implementation

{$R *.DFM}

procedure TFdFiltrarGrupo.FormClose(Sender: TObject;
...
procedure TFdFiltrarGrupo.BitBtnAnularFiltroClick(Sender: TObject);
var i:Integer;
begin
 tdFiltroGrupo.Edit;
...
procedure TFdFiltrarGrupo.BitBtnFiltrarClick(Sender: TObject);
...
procedure TFdFiltrarGrupo.dMenuArbol1SelectID(Sender: tnMenuItem;
...
procedure TFdFiltrarGrupo.FormKeyPress(Sender: TObject; var Key: Char);
begin
 if (Key = #13) then
...
procedure TFdFiltrarGrupo.FormCreate(Sender: TObject);
begin
...
procedure TFdFiltrarGrupo.FormDestroy(Sender: TObject);
begin
  Query := nil;
  Query.Free;
  ListaDatos.Free;
...
procedure TFdFiltrarGrupo.CargarFiltro(Lista: TStringList);
var I:Integer;
begin
