...
type
  TFQRListadoContrato = class(TForm)
    QuickRep: TQuickRep;
    BandaTitulo: TQRBand;
...
var
  FQRListadoContrato: TFQRListadoContrato;
...
procedure TFQRListadoContrato.QuickRepAfterPreview(Sender: TObject);
begin
  try
    Close;
  except
...
procedure TFQRListadoContrato.FormClose(Sender: TObject;
...
procedure TFQRListadoContrato.FormShow(Sender: TObject);
begin
  QuickRep.Preview;
end;

procedure TFQRListadoContrato.FormCreate(Sender: TObject);
begin
  ListaRotulos := TStringList.Create;
  ListaDatos := TStringList.Create;
end;

procedure TFQRListadoContrato.FormDestroy(Sender: TObject);
begin
  ListaRotulos.Free;
  ListaDatos.Free;
end;

procedure TFQRListadoContrato.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
...
procedure TFQRListadoContrato.qrdbHoraFinPrint(sender: TObject;
  var Value: String);
begin
...
procedure TFQRListadoContrato.qrdbFechaEmisionPrint(sender: TObject;
  var Value: String);
begin
